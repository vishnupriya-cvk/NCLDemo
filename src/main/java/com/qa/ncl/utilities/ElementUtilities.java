...
public class ElementUtilities {
	...
	public void breakXpathAndSelect(String beforeXpath,String place,String afterXpath ) {	
		String dPlace=place.toLowerCase();
		String xpath=beforeXpath+dPlace+afterXpath;
